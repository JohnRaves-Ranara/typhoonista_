...
class textStyles{
  ...
  static lato_black({double? fontSize, Color? color, bool? underlined}) => TextStyle(fontFamily: 'lato_black', fontSize: fontSize, color: color, decoration: (underlined==true) ? TextDecoration.underline : null);
