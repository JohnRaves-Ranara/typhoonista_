                                    ...
                                    Container(
                                        ...
                                        child:
                                            ...
                                            //                 ? Information(customState)
                                                            :
                                            add_day(customState: customState
                                                // recentEstimation,
                                                )),
                                  ],
                                );
              ...
              child: InkWell(
                ...
                onTap: (() async {
                  await FirestoreService2()
                      .addTyphoon(typhoonNameCtrlr.text.trim());
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: (() async {
                          ...
                          provincesFromJSON.forEach((prov) => provinces.add(
                              Location(
                                  provID: prov.provID,
